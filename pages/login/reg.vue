	...
	<view class="content">
		...
		<view class="list">
			<view class="list-call">
				...
				<input class="sl-input" v-model="username" type="text" maxlength="12" placeholder="昵称" />
			</view>
			<view class="list-call">
				<image class="img" src="/static/shilu-login/1.png"></image>
				<input class="sl-input" @blur="phoneIsReg()" v-model="phone" type="number" maxlength="11"
					placeholder="手机号" />
			</view>
			<view class="list-call">
	...
	export default {
		...
		methods: {
			...
			bindLogin() {
				...
				api.request({
					url: '/userLogin/register/' + this.code,
					data: {
						phone: this.phone,
