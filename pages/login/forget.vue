	...
	<view class="content">
		<view class="list">
			...
			<view class="list-call">
				...
				<input class="sl-input" @blur="phoneIsReg()" type="number" v-model="phone" maxlength="11"
					placeholder="请输入手机号" />
			</view>
			<view class="list-call">
	...
	export default {
		...
		phoneIsReg() {
			...
			getcode() {
				...
				api.request({
					url: '/userLogin/sendForgetPassword', //仅为示例，并非真实接口地址。
					data: {
						phone: this.phone,
					},
					method: 'GET',
			...
			bindLogin() {
				...
				api.request({
					url: '/userLogin/editPassword/' + this.code,
					data: {
						phone: this.phone,
